...
2. Install pip for python 3 (if not already installed): sudo apt install python3-pip

3. Install OpenCV for python: pip install opencv-python

4. Install numpy: pip install numpy

5. Install pytorch (for example: CUDA 12.1): pip install torch==2.4.1 torchvision==0.19.1 torchaudio==2.4.1 --index-url https://download.pytorch.org/whl/cu121

6. Install pillow: pip install pillow

7. Install matplotlib: sudo apt install python3-matplotlib

8. Install flashtorch: pip install flashtorch
